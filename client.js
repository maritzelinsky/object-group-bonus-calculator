...
function bonus(employeesArray){
  for(let i = 0; i < employeesArray.length; i++){
    if (employeesArray[i].reviewRating == 5){
      console.log('This is a review bonus', employeesArray[i].annualSalary * .1);
    }
    else if (employeesArray[i].reviewRating == 3){
      console.log('This is a review bonus',employeesArray[i].annualSalary * .04);
    }
    else if (employeesArray[i].reviewRating == 4){
      console.log('This is a review bonus',employeesArray[i].annualSalary * .06);
    }
    else {
...
function seniority(additionalBonus) {
  for (let i = 0; i < additionalBonus.length; i++) {
    if(additionalBonus[i].employeeNumber.length == 4) {
      console.log('additionalBonus', additionalBonus[i].annualSalary * .05); 
    }
    else {
      console.log('no additional bonus');
    }
